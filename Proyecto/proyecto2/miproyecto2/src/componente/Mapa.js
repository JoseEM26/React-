...
import Imagen1 from "../imagenes/imgubi.jpg"
import Imagen2 from "../imagenes/iconohora.jpg"
import Imagen3 from "../imagenes/oficina 2.jpg"
import Imagen4 from "../imagenes/logowsp.jpg"
import Imagen5 from "../imagenes/logocorreo.jpg"
    ...
    return (
        <div class="Body">
            ...
            <div className="Datos2">
                ...
                <div>
                    <h1>Hora de Atencion</h1>
                    <p>Lunes a Lunes de 09:00 - 21:00</p>
                </div>
            </div>
...
function Ubica() {
    return (
        <div class="map">
            <iframe width="110%" height="260" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
