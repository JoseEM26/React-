...
function Comidas() {
  ...
  return (
    <main className="Lejos">
      <Comida title="IPHONE" items={especialidadesItems} id="IPHONE" />
      <Comida title="MACKBOOK" items={milkshakesItems} id="MACKBOOK" />
      <Comida title="REPUESTOS" items={frapsItems} id="REPUESTOS" />
      <Comida title="ACCESORIOS" items={cafeItems} id="ACCESORIOS" />
      <Comida title="DESCUENTOS" items={frozenItems} id="DESCUENTOS" />
    </main>
  );
