...
function Imagubi() {
    return (
        <img src={"/"} className="imgub" alt="ubi" />
    );
}

function Imaghora() {
    return (
        <img src={"/"} className="imghr" alt="hor" />
    );
}

function Ubicacion() {
    return (
        <img src={"/"} className="imgdere" alt="dere" />
    );
}

function Imagwsp() {
    return (
        <img src={"/"} className="imgwsp" alt="wsp" />
    );
}

function Imagcorre() {
    return (
        <img src={"/"} className="imgcorre" alt="corre" />
    )
}
